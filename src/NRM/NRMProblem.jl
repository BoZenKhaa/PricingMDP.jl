...
"""
Set product arrival probablities from homogenous Pois. proc. intensities λ, 
...
"""
function set_product_request_probs!(product_request_probs::Array{Float64}, t::Timestep,  λ::Array{Float64}, selling_period_ends::Array{Timestep})
