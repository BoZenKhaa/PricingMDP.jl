...
@testset "HistoryReplayer.jl" begin
    ...
    # Test gen method
    s = trace[1].s
    (sp, r, info) = POMDPs.gen(hrpl, s, 1000.0, MersenneTwister(99))
    @test sp == trace[2].s
    @test r == 0.0
